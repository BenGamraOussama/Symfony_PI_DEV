 ...
 */
final class Version20250219012422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, dossier_medical_path VARCHAR(255) DEFAULT NULL, gener VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, dossier_medical VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
