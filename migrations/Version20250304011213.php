 ...
 */
final class Version20250304011213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient_activite (activite_id INT NOT NULL, patient_id INT NOT NULL, INDEX IDX_8FF00DB09B0F88B1 (activite_id), INDEX IDX_8FF00DB06B899279 (patient_id), PRIMARY KEY(activite_id, patient_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, user_id INT DEFAULT NULL, dossier_medical_path VARCHAR(255) DEFAULT NULL, gener VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, suspended_until DATETIME DEFAULT NULL, bad_word_attempts INT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_1ADAD7EBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
