 ...
 */
final class Version20250303011251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE psychiatre (id INT NOT NULL, consultation_id INT DEFAULT NULL, specialite VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, INDEX IDX_559A887F62FF6CDF (consultation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, psychiatre_id INT DEFAULT NULL, patient_id INT DEFAULT NULL, heure TIME NOT NULL, date DATE NOT NULL, priorite VARCHAR(255) NOT NULL, INDEX IDX_10C31F86DA6C8211 (psychiatre_id), INDEX IDX_10C31F866B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
