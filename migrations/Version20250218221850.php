 ...
 */
final class Version20250218221850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rdv DROP patient_id, DROP psychiatre_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE rdv ADD patient_id INT DEFAULT NULL, ADD psychiatre_id INT DEFAULT NULL');
