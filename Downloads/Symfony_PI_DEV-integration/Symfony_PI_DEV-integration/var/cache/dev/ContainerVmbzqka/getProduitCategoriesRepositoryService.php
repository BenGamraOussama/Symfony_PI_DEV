 ...
 */
class getProduitCategoriesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitCategoriesRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitCategoriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitCategoriesRepository.php';

        return $container->privates['App\\Repository\\ProduitCategoriesRepository'] = new \App\Repository\ProduitCategoriesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
