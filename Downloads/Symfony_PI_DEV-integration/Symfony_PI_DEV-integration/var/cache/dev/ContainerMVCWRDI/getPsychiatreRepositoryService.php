 ...
 */
class getPsychiatreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PsychiatreRepository' shared autowired service.
     *
     * @return \App\Repository\PsychiatreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PsychiatreRepository.php';

        return $container->privates['App\\Repository\\PsychiatreRepository'] = new \App\Repository\PsychiatreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
