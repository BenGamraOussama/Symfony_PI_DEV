...
class __TwigTemplate_c73d267aa2d39e03bd01288c8d99a7c4 extends Template
{
    ...
    <div class=\"card shadow\">
        <div class=\"card-header bg-primary text-white\">
            <div class=\"d-flex justify-content-between align-items-center\">
                <h2 class=\"h4 mb-0\">Create New Exercice</h2>
                <a href=\"";
        // line 11
...
<div class=\"container-fluid py-4\">
    <div class=\"card shadow\">
        <div class=\"card-header bg-primary text-white\">
            <div class=\"d-flex justify-content-between align-items-center\">
                <h2 class=\"h4 mb-0\">Create New Exercice</h2>
                <a href=\"{{ path('app_exercice_index') }}\" class=\"btn btn-light btn-sm\">
                    <i class=\"bi bi-arrow-left\"></i> Back to List
                </a>
            </div>
        </div>
...
{% endblock %}", "exercice/new.html.twig", "C:\\Users\\Lenovo\\Downloads\\Symfony_PI_DEV-integration\\Symfony_PI_DEV-integration\\templates\\exercice\\new.html.twig");
    }
}
