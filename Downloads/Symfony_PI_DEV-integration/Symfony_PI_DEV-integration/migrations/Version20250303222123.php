 ...
 */
final class Version20250303222123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD average_rating DOUBLE PRECISION DEFAULT NULL, DROP rating, CHANGE prix prix DOUBLE PRECISION NOT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE patient CHANGE dossier_medical_path dossier_medical_path VARCHAR(255) DEFAULT \'NULL\', CHANGE gener gener VARCHAR(255) DEFAULT \'NULL\', CHANGE adresse adresse VARCHAR(255) DEFAULT \'NULL\', CHANGE name name VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE produit ADD rating DOUBLE PRECISION DEFAULT \'NULL\', DROP average_rating, CHANGE prix prix VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) DEFAULT \'NULL\'');
